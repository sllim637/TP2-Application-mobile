...
class MainActivity : AppCompatActivity(), AdapterView.OnItemSelectedListener  {
    ...
    var students = ArrayList<Etidiant>()

    var etud = ArrayList<Etidiant>()
    ...
    fun createStudents() {
        ...
        for(i in 1..20){
            ...
            this.students.add(Etidiant("nom$i","prenom$i",genre))
        }
    }
    fun filter (name : String) : ArrayList<Etidiant>{
        var filteredList = ArrayList<Etidiant>()
