...
class CustomAdapter(private val data: ArrayList<Etidiant>) :
        RecyclerView.Adapter<CustomAdapter.ViewHolder>() , Filterable {

        var dataFilterList = ArrayList<Etidiant>()
        init {
        ...
        override fun onBindViewHolder(holder: ViewHolder, position: Int) {
                ...
                if(ItemsViewModel.genre == "male"){
                        holder.imageView.setImageResource(R.drawable.man_avatar)
                }else{
                        holder.imageView.setImageResource(R.drawable.male_avatar)
                }
                ...
                return object : Filter(){
                        override fun performFiltering(constraint: CharSequence?): FilterResults {
                                ...
                                if (charSearch.isEmpty()) {
                                        ...
                                        val resultList = ArrayList<Etidiant>()
                                        for (student in data) {
                        ...
                        override fun publishResults(constraint: CharSequence?, results: FilterResults?) {
                                dataFilterList = results?.values as ArrayList<Etidiant>
